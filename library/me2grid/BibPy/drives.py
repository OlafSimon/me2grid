...
class CanOpenDrive(CanOpenNode):
    ...
    def switchtoPositionMode(self, velocity : int):
    ...
    def setPos(self, position, velocity=None, relative=False, wait=True):
    ...
    def setVelocity(self, velocity):
        ...
        self.writeParam(Obj.TargetVelocity,0, velocity) # Velocity
    ...
    def getPos(self):
        ...
        return valid, posi/self.IncPerTurn
